...
public class Dao {
    ...
    public int getMaxRowAOrderTable() {
        ...
        try {
            ...
            Logger.getLogger(Dao.class.getName()).log(Level.SEVERE, "getMaxRowAdminTable failed", ex);
        }
        return row + 1;
    }
    ...
    public double subTotal() throws SQLException {
        double subTotal = 0.0;
        String sql = "SELECT SUM(total) as total FROM cart"; 
